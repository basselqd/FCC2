...
In the course of its development MagLua has undergone a number of revisions that have extend its capabilities. All versions of maglua available online:

https://github.com/jasonimercer/maglua

svn versions have been converted to git tags available as the following:
